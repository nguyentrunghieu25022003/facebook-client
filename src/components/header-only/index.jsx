          ...
          <div className="col-xl-12 col-md-12 col-sm-12 col-12">
            <div className="d-flex align-items-center justify-content-between">
              ...
              >
                ...
                <div className={cx("navigation-item")}>
                  <Link to="/friends" onClick={() => setIsActive("friends")} className={isActive === "friends" ? cx("active") : "" }>
                    <PeopleOutlineIcon className={cx("icon")} />
                  </Link>
                </div>
                <div className={cx("navigation-item")}>
                  <Link to="/watch" onClick={() => setIsActive("watch")} className={isActive === "watch" ? cx("active") : "" }>
                    <OndemandVideoIcon className={cx("icon")} />
                  </Link>
                </div>
                <div className={cx("navigation-item")}>
                  <Link to="/market" onClick={() => setIsActive("market")} className={isActive === "market" ? cx("active") : "" }>
                    <StorefrontIcon className={cx("icon")} />
                  </Link>
                </div>
                <div className={cx("navigation-item")}>
                  <Link to="/group" onClick={() => setIsActive("group")} className={isActive === "group" ? "active" : "" }>
              ...
              >
                    ...
                    <div>
                      <div className={cx("message-header")}>
                        ...
                        <form className={cx("search-chat")}>
                          <button type="submit"><SearchIcon className="fs-1 text-secondary" /></button>
                ...
                >
                  <div className={cx("circle")} id={cx("chat")}>
                    {countMessages > 0 && <div className={cx("circle-number")}>{countMessages}</div>}
                ...
                <Tippy
                  ...
                  content={
                    <div className={cx("table-custom")}>
                      <div className="d-flex align-items-center justify-content-between">
                        <h5 className={cx("notification-heading")}>Notification</h5>
                        <Tippy>
                          <MoreHorizIcon className="fs-1 text-secondary" />
                        </Tippy>
                      </div>
                ...
                >
                  <div className={cx("circle")} id={cx("notifications")}>
                    {countNotifications > 0 && <div className={cx("circle-number")}>{countNotifications}</div>}
                    ...
                    <div className={cx("account-setting")}>
                      ...
                      <div className={cx("icon-box")}>
                        <Link className="d-flex align-items-center gap-4 pt-3 pr-3 pb-3 pl-3">
                          <span><SettingsIcon className="fs-1" /></span>
                          <strong className="fw-bold">Settings & privacy</strong>
                        </Link>
                      </div>
                      <div className={cx("icon-box")}>
                        <Link className="d-flex align-items-center gap-4 pt-3 pr-3 pb-3 pl-3">
                          <span><HelpIcon className="fs-1" /></span>
                          <strong className="fw-bold">Help & support</strong>
                        </Link>
                      </div>
                      <div className={cx("icon-box")}>
                        <Link className="d-flex align-items-center gap-4 pt-3 pr-3 pb-3 pl-3">
                          <span><ReportIcon className="fs-1" /></span>
                          <strong className="fw-bold">Contribute comments</strong>
                        </Link>
                      </div>
                      <div className={cx("icon-box")}>
                        <button className="d-flex align-items-center gap-4 pt-3 pr-3 pb-3 pl-3" onClick={handleLogout}>
                          <span><LogoutIcon className="fs-1" /></span>
                          <strong className="fw-bold">Logout</strong>
                        </button>
                      </div>
                      <ul className="d-flex flex-wrap gap-4 ml-3" style={{ margin: "5px 0 0 25px" }}>
